...
$id = $_GET['id'];
$queryedit = "SELECT * FROM pembayaran WHERE id = '$id'"; //mengambil semua kolom dari table
$edit = ambilsatubaris($conn,$queryedit); //inisiasi variabel baru untuk merubah data menjadi array asosiatif
...
if(isset($_POST['btn-simpan'])){
    ...
    $execute = bisa($conn,$query); //inisiai variabel baru untuk cek data berhasil/tidak
    if($execute == 1){
        $success = 'true';
        $title = 'Berhasil';
