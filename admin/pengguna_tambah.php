...
if(isset($_POST['btn-simpan'])){
    ...
    $insert_stmt = $conn->prepare($query_template); // untuk mengeksekusi query dengan aman, mencegah serangan SQL injection.

    // untuk mengaitkan parameter pada prepared statement dengan nilai-nilai yang akan dimasukkan.
    $insert_stmt->bind_param("ssss", $username, $nama, $password, $role);

    //untuk mengecek apakah eksekusi prepared statement berhasil atau gagal
